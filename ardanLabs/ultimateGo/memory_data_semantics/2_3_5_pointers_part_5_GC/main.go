...
// which is basically in place to ensure that we don't have data races and the GC doesn't get to close
...
// This is for Go 1.13 and less. 1.14 and greater use a preimptive scheduler so we Go can do a context
// switch when it wants rather than waiting for a func call. 
